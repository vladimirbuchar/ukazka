...
export class UpdateCopurseTerm {
    ...
    public Lector: [] ;
    constructor(id:string, price:Price,activeFrom: Date,activeTo:Date,registrationFrom:Date,registrationTo:Date, minimumStudents:number, maximumStudents:number, classRoomId: string, monday:boolean, tuesday:boolean,wednesday:boolean, thursday:boolean, friday:boolean, saturday:boolean, sunday:boolean, timeFromId: string, timeToId:string, userAccessToken: string, name:string, description:string, lector:[])
    {
        this.Id = id;
        this.Price = price;
